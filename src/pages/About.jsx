  ...
  const sections = [
    {
      ...
      content: (
        <p className="text-muted-foreground leading-relaxed">
          The Department of CST, CSIT, CSE(CS) & CSE(NW) programme at UEMK is a unique blend of hardware and software, allowing students to gain knowledge about the concepts that enable many of today’s fundamental technologies, including artificial intelligence & machine Learning, Wireless Communication and the Internet of Things. The Department introduces fundamental concepts of Computer Science, Information Technology, Cybersecurity and Networks and imparts knowledge dealing with logical reasoning, problem-solving, data representation, abstraction etc. The initial level courses provide students with a core foundation in programming, mathematical reasoning, physics, and circuit design. The latter part blends fundamentals in computer technologies including software engineering, database management system, computer networks, operating systems, and computer architecture with fundamentals in electrical and electronics engineering. Currently, the Department runs a four-year B. Tech in CST, CSIT, CSE(CS) & CSE(NW) courses to prepare students with a firm foundation of both the theory and practice of Computer Science and Information technology through a comprehensive undergraduate program and to strengthen creativity, nurture innovation and develop the ability to carry out research and solve real-world problems.
        </p>
      ),
    },
    {
